...
import { QuickActions, NavigationStats } from "../components/Navigation";
        ...
        <div className="container mx-auto px-6 py-12">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Your intelligent farming companion. Monitor crop health, get real-time weather updates,
              and make data-driven decisions for better yields.
            </p>
              ...
              <div className="space-y-3">
                ...
                <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                  <p className="text-sm text-blue-800">
                    <strong>💡 Tip:</strong> {weatherData.irrigationTip}
                  </p>
                </div>
              </div>
            </div>
